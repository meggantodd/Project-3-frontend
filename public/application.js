...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onViewAllUsers = function onViewAllUsers(event) {
	  console.log('onViewAllUsers in events working');
	  event.preventDefault();
	  api.viewAllUsers().then(ui.viewAllUsersSuccess).catch(ui.viewAllUsersFailure);
	};
	...
	var onSignIn = function onSignIn(event) {
	  ...
	  var data = getFormFields(this);
	  event.preventDefault();
	  api.signIn(data).then(ui.signInSuccess).then(ui.checkForUserBlog).then(ui.checkForUserPages).catch(ui.signInFailure);
	};
	...
	var onViewAllPages = function onViewAllPages(event) {
	  console.log('onViewAllPages in events working');
	  event.preventDefault();
	  api.viewAllPages().then(ui.viewAllPagesSuccess).catch(ui.viewAllPagesFailure);
	};

	var openCreatePageModal = function openCreatePageModal(event) {
	...
	var onCreatePage = function onCreatePage(event) {
	  ...
	  $('#submit-create-page').click(function (event) {
	    ...
	    api.createPage(values).then(ui.createPageSuccess).catch(ui.createPageFailure);
	  });
	...
	var openCreateBlogModal = function openCreateBlogModal(event) {
	...
	var onCreateBlog = function onCreateBlog(event) {
	  ...
	  $('#submit-create-blog').click(function (event) {
	    ...
	    api.createBlog(values).then(function (values) {
	      console.log('this is values ', values);
	      return values;
	    }).then(ui.createBlogSuccess).catch(ui.createBlogFailure);
	  });
	...
	var onViewMyBlog = function onViewMyBlog(event) {
	  console.log('onViewMyBlog in events working');
	  event.preventDefault();
	  api.viewAllBlogs().then(ui.viewMyBlogSuccess).catch(ui.viewMyBlogFailure);
	};
	...
	var onUpdatePost = function onUpdatePost(event) {
	  ...
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.updatePost(data).then(ui.updatePostSuccess).catch(ui.updatePostFailure);
	};

	var onViewMyPages = function onViewMyPages(event) {
	  console.log('onViewMyPages in events working');
	  event.preventDefault();
	  api.viewAllPages().then(ui.viewMyPagesSuccess).catch(ui.viewMyPagesFailure);
	};

	var onViewPost = function onViewPost(event) {
	  console.log('onViewPost in events working');
	  event.preventDefault();
	  // const data = ($(this).parent().attr('data-id'))
	  var data = getFormFields(this);
	  api.viewPost(data).then(ui.viewPostSuccess).catch(ui.viewPostFailure);
	};
	var onDeletePost = function onDeletePost(event) {
	  ...
	  // const data = ($(this).parent().attr('data-id'))
	  var data = getFormFields(this);
	  api.deletePost(data).then(ui.deletePostSuccess).catch(ui.deletePostFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var viewAllUsers = function viewAllUsers(data) {
	...
	var viewUserPages = function viewUserPages(userId) {
	...
	var viewUserBlogs = function viewUserBlogs(userId) {
	...
	var viewAllPages = function viewAllPages(data) {
	...
	var viewPage = function viewPage(data) {
	...
	var updatePage = function updatePage(data, id) {
	...
	var deletePage = function deletePage(data) {
	...
	var viewAllBlogs = function viewAllBlogs(data) {
	...
	var viewBlog = function viewBlog(data) {
	  return $.ajax({
	    url: app.host + '/blogs/' + data,
	    method: 'GET'
	  });
	};
	var updateBlog = function updateBlog(data, id) {
	  return $.ajax({
	...
	var viewPost = function viewPost(data) {
	...
	var createPost = function createPost(data, blogId) {
	  console.log('this is data ', data);
	...
	var updatePost = function updatePost(data, blogId, postId) {
	  // console.log('this is data.posts ', data.posts)
	  console.log('this is blogId', blogId);
	...
	var deletePost = function deletePost(blogId, postId) {
	...
	module.exports = {
	  ...
	  viewUserPages: viewUserPages,
	  viewUserBlogs: viewUserBlogs
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports) {
	...
	var host = 'https://guarded-bastion-33741.herokuapp.com';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(8);
	var showPagesTemplate = __webpack_require__(10);
	var showBlogsTemplate = __webpack_require__(31);
	var showMyBlogTemplate = __webpack_require__(32);
	var showAllUsersTemplate = __webpack_require__(33);
	var showOnePageTemplate = __webpack_require__(34);
	var showOneBlogTemplate = __webpack_require__(35);
	var showMyPagesTemplate = __webpack_require__(36);
	var api = __webpack_require__(6);
	...
	var onViewMyAssets = function onViewMyAssets(event) {
	  console.log('onViewUserAssets in events working');
	  event.preventDefault();
	  console.log('this is store.user ', store.user);
	  var data = store.user.id;
	  api.viewUserPages(data).then(viewMyPagesSuccess).then(function () {
	    return api.viewUserBlogs(data);
	  }).then(viewMyBlogSuccess).catch(viewMyPagesFailure);
	};

	var checkForUserBlog = function checkForUserBlog(event) {
	  console.log('checkForUserBlog running');
	  var data = store.user.id;
	  api.viewUserBlogs(data).then(checkForUserBlogSuccess);
	};

	var checkForUserBlogSuccess = function checkForUserBlogSuccess(data) {
	...
	var checkForUserPages = function checkForUserPages(event) {
	  console.log('checkForUserPages running');
	  var data = store.user.id;
	  api.viewUserPages(data).then(checkForUserPagesSuccess);
	};

	var checkForUserPagesSuccess = function checkForUserPagesSuccess(data) {
	...
	var viewAllUsersSuccess = function viewAllUsersSuccess(data) {
	  console.log(data);
	  $('.content').show();
	  $('.content').html('');
	  var showUsersHtml = showAllUsersTemplate({ users: data.users });
	  $('.content').append(showUsersHtml);

	  $('.user-button').on('click', onViewUserAssets);
	};

	var onViewUserAssets = function onViewUserAssets(event) {
	  console.log('onViewUserAssets in events working');
	  event.preventDefault();
	  ...
	  .then(viewUserPagesSuccess).then(function () {
	    return api.viewUserBlogs(data);
	  })
	  // this one expects that "pages" are already there and appends to that div
	  .then(viewUserBlogSuccess).catch(viewUserPagesFailure);
	};

	var viewUserBlogSuccess = function viewUserBlogSuccess(data) {
	  console.log('data is', data);
	  $('.content').show();
	  var showBlogsHtml = showBlogsTemplate({ blogs: data.blogs });
	  $('.content').append(showBlogsHtml);
	  // once user clicks on View Blog
	  $('.view-blog').on('click', onViewBlog);
	};

	var viewUserPagesSuccess = function viewUserPagesSuccess(data) {
	  console.log('data is', data);
	  $('.content').show();
	  $('.content').html('');
	  var showPagesHtml = showPagesTemplate({ pages: data.pages });
	  $('.content').append(showPagesHtml);
	  // once user clicks on View Page
	  $('.view-page').on('click', onViewPage);
	};

	var viewUserPagesFailure = function viewUserPagesFailure(error) {
	  return error;
	};
	var onViewPage = function onViewPage(event) {
	  event.preventDefault();
	  var data = $(this).parent().attr('data-id');
	  api.viewPage(data).then(viewPageSuccess).catch(viewPageFailure);
	};

	var onViewBlog = function onViewBlog(event) {
	  console.log('onViewBlog in ui working');
	  event.preventDefault();
	  console.log('this is data-id ', $(this).parent().attr('data-id'));
	  var data = $(this).parent().attr('data-id');
	  api.viewBlog(data).then(viewBlogSuccess).catch(viewBlogFailure);
	};
	var viewUserAssetsFailure = function viewUserAssetsFailure(error) {
	  return error;
	};

	var viewAllUsersFailure = function viewAllUsersFailure(error) {
	  return error;
	};

	var viewAllPagesSuccess = function viewAllPagesSuccess(data) {
	  ...
	  $('.edit-button').on('click', function (event) {
	    var pageId = $(event.target).parent().attr('data-id');
	    var pageTitle = $(event.target).parent().find('#page-title').text();
	    var pageContent = $(event.target).parent().find('#page-content').text();
	...
	var openUpdatePageModal = function openUpdatePageModal(event) {
	  $('#edit-page-modal').show();
	};

	var viewMyPagesSuccess = function viewMyPagesSuccess(data) {
	...
	var onViewMyPage = function onViewMyPage(event) {
	  event.preventDefault();
	  var data = $(this).parent().attr('data-id');
	  api.viewPage(data).then(viewMyPageSuccess).catch(viewMyPageFailure);
	};

	var viewMyPageSuccess = function viewMyPageSuccess(data) {
	  $('.content').show();
	  $('.content').html('');
	  var showMyPagesHtml = showMyPagesTemplate({ pages: data });
	  $('.content').append(showMyPagesHtml);

	  $('.remove-button').on('click', onDeletePage);
	  $('.return-to-dashboard').on('click', rerunAssetsHandlebars);
	  $('.edit-button').on('click', function (event) {
	    var pageId = $(event.target).parent().find('#page-id').val();
	    var pageTitle = $(event.target).parent().find('#page-title').text();
	    var pageContent = $(event.target).parent().find('#page-content').text();
	...
	var viewMyPageFailure = function viewMyPageFailure(error) {
	  return error;
	};
	var viewMyPagesFailure = function viewMyPagesFailure(error) {
	  console.log('viewMyPagesFailure in ui');
	  return error;
	};

	var onUpdatePage = function onUpdatePage(pageId, pageTitle, pageContent) {
	  event.preventDefault();
	  $('#edit-page-modal').show();
	  ...
	  $('#submit-page-edit').click(function (event) {
	    ...
	    console.log(values);
	    api.updatePage(values, pageId).then(updatePageSuccess).then(rerunMyPageHandlebars).catch(updatePageFailure);
	  });
	...
	var updatePageSuccess = function updatePageSuccess(data) {
	  $('.clear').val('');
	  $('#edit-page-modal').hide();
	  $('#failure').hide();
	  return data;
	...
	var rerunMyPageHandlebars = function rerunMyPageHandlebars(redisplay) {
	  $('.content').show();
	  var data = $('.content').find('input').val();
	  api.viewPage(data).then(viewMyPageSuccess).catch(viewMyPageFailure);
	};

	var updatePageFailure = function updatePageFailure(error) {
	  $('#failure').show();
	...
	var onDeletePage = function onDeletePage(event) {
	  var data = $('.content').find('input').val();
	  api.deletePage(data).then(deletePageSuccess, $(this).parent().hide(400)).then(rerunAssetsHandlebars).catch(deletePageFailure);
	};

	var viewAllPagesFailure = function viewAllPagesFailure(error) {
	  return error;
	};
	var viewPageSuccess = function viewPageSuccess(data) {
	  console.log('data is', data);
	  $('.content').show();
	  $('.content').html('');
	  var showPageHtml = showOnePageTemplate({ pages: data });
	...
	var onReturnUserAssets = function onReturnUserAssets(event) {
	  event.preventDefault();
	  console.log('event.target is', event.target);
	  // this grabs the page._owner value, which is user ID
	  var data = $(this).parent().attr('data-id');
	  // the rest of the function is spitting out user assets
	  api.viewUserPages(data).then(viewUserPagesSuccess).then(function () {
	    return api.viewUserBlogs(data);
	  }).then(viewUserBlogSuccess).catch(viewUserPagesFailure);
	};
	var viewPageFailure = function viewPageFailure(error) {
	  return error;
	};
	var createPageSuccess = function createPageSuccess(data) {
	  $('#create-page-modal').hide(400);
	  $('.clear').val('');
	  $('#failure').hide();
	...
	var createPageFailure = function createPageFailure(error) {
	  $('#failure').show();
	...
	var deletePageSuccess = function deletePageSuccess(data) {
	  $('.clear').val('');
	};
	var rerunAssetsHandlebars = function rerunAssetsHandlebars(rerun) {
	  var data = store.user.id;
	  api.viewUserPages(data).then(viewMyPagesSuccess).then(function () {
	    return api.viewUserBlogs(data);
	  }).then(viewMyBlogSuccess).catch(viewMyPagesFailure);
	};
	var deletePageFailure = function deletePageFailure(error) {
	  console.log('deletePageFailure in ui');
	  return error;
	};

	var createBlogSuccess = function createBlogSuccess(data) {
	  $('.clear').val('');
	...
	var createBlogFailure = function createBlogFailure(error) {
	  // $('#failure').html('')
	...
	var viewAllBlogsFailure = function viewAllBlogsFailure(error) {
	  return error;
	};
	...
	var viewMyBlogSuccess = function viewMyBlogSuccess(data) {
	  $('.content').show();
	  var showMyBlogHtml = showBlogsTemplate({ blogs: data.blogs });
	  $('.content').append(showMyBlogHtml);
	  $('.view-blog').on('click', onViewMyBlog);
	};
	var onViewMyBlog = function onViewMyBlog(event) {
	  var data = $(event.target).parent().attr('data-id');
	  api.viewBlog(data).then(viewMyBlogPostsSuccess).catch(viewMyBlogPostsFailure);
	};

	var viewMyBlogPostsSuccess = function viewMyBlogPostsSuccess(data) {
	  $('.content').show();
	  $('.content').html('');
	  var showMyBlogPostsHtml = showMyBlogTemplate({ blogs: data });
	  $('.content').append(showMyBlogPostsHtml);
	  // to edit blog title
	  $('.edit-blog-title').on('click', function (event) {
	    var blogId = $(event.target).parent().find('#blog-id').val();
	    var blogTitle = $(event.target).parent().find('#blog-title').text();
	    openUpdateBlogTitleModal(event);
	    onUpdateBlogTitle(blogId, blogTitle);
	  });
	  // to create a blog post
	  $('.create-blog-post').on('click', function (event) {
	    var blogId = $(event.target).parent().find('input').val();
	  ...
	  $('.edit-post-button').on('click', function (event) {
	    var blogId = $(event.target).parent().parent().find('#blog-id').val();
	    console.log('this is blog-id merp', blogId);
	    var postId = $(event.target).parent().find('input').val();
	    console.log('this is post-id merp', postId);

	    var postTitle = $(event.target).parent().find('#post-title').text();
	    var postBody = $(event.target).parent().find('#post-body').text();
	...
	var openUpdateBlogTitleModal = function openUpdateBlogTitleModal(event) {
	  $('#edit-blog-modal').show();
	};

	var onUpdateBlogTitle = function onUpdateBlogTitle(blogId, blogTitle) {
	  ...
	  $('#submit-blog-edit').click(function (event) {
	    ...
	    $('#submit-blog-edit').off();
	    api.updateBlog(values, blogId).then(updateBlogTitleSuccess).then(rerunMyBlogHandlebars).catch(updateBlogTitleFailure);
	  });
	...
	var updateBlogTitleSuccess = function updateBlogTitleSuccess(data) {
	  $('.clear').val('');
	  $('#edit-blog-modal').hide(400);
	  $('#failure').hide();
	  return data;
	...
	var updateBlogTitleFailure = function updateBlogTitleFailure(error) {
	  $('#failure').show();
	...
	var rerunMyBlogHandlebars = function rerunMyBlogHandlebars(event) {
	  $('.content').show();
	  var data = $('.content').find('input').val();
	  api.viewBlog(data).then(viewMyBlogPostsSuccess).catch(viewMyBlogPostsFailure);
	};
	var openCreatePostModal = function openCreatePostModal(event) {
	...
	var onCreatePost = function onCreatePost(blogId, postTitle, postBody) {
	  $('#create-post-modal').show();
	  event.preventDefault();
	  ...
	  $('#submit-create-post').click(function (event) {
	    ...
	    api.createPost(values, blogId).then(createPostSuccess).then(rerunMyBlogHandlebars).catch(createPostFailure);
	  });
	...
	var openUpdatePostModal = function openUpdatePostModal(event) {
	  $('#edit-post-modal').show();
	};

	var onUpdatePost = function onUpdatePost(blogId, postId, postTitle, postBody) {
	  $('#edit-post-modal').show();
	  ...
	  $('#submit-post-edit').click(function (event) {
	    ...
	    api.updatePost(values, blogId, postId).then(updatePostSuccess).then(rerunMyBlogHandlebars).catch(updatePostFailure);
	  });
	...
	var onDeletePost = function onDeletePost(event) {
	  var blogId = $(event.target).parent().parent().find('#blog-id').val();
	  var postId = $(event.target).parent().find('input').val();
	  api.deletePost(blogId, postId).then(deletePostSuccess, $(undefined).parent().hide(400)).then(rerunMyBlogHandlebars).catch(deletePostFailure);
	};
	var viewMyBlogPostsFailure = function viewMyBlogPostsFailure(error) {
	  return error;
	};

	var viewMyBlogFailure = function viewMyBlogFailure(error) {
	  return error;
	};
	var viewBlogSuccess = function viewBlogSuccess(data) {
	  $('.content').show();
	  $('.content').html('');
	  var showBlogHtml = showOneBlogTemplate({ blogs: data });
	  $('.content').append(showBlogHtml);
	  // this button returns visiter back to user home site
	  $('.back-to-user-site').on('click', onReturnUserAssets);
	};

	var viewBlogFailure = function viewBlogFailure(error) {
	  return error;
	};

	var viewPostSuccess = function viewPostSuccess() {
	  console.log('post was successful');
	};

	var viewPostFailure = function viewPostFailure(error) {
	  return error;
	};

	var updateBlogSuccess = function updateBlogSuccess(data) {};

	var updateBlogFailure = function updateBlogFailure(error) {
	  return error;
	};
	...
	module.exports = {
	  ...
	  viewAllPagesSuccess: viewAllPagesSuccess,
	  viewAllPagesFailure: viewAllPagesFailure,
	  ...
	  // viewAllBlogsSuccess,
	  viewAllBlogsFailure: viewAllBlogsFailure,
	  deletePageSuccess: deletePageSuccess,
	  deletePageFailure: deletePageFailure,
	  onDeletePage: onDeletePage,
	  openUpdatePageModal: openUpdatePageModal,
	  onUpdatePage: onUpdatePage,
	  updatePageSuccess: updatePageSuccess,
	  updatePageFailure: updatePageFailure,
	  viewMyPagesSuccess: viewMyPagesSuccess,
	  viewMyPagesFailure: viewMyPagesFailure,
	  // rerunMyPagesHandlebars,
	  viewPageSuccess: viewPageSuccess,
	  viewPageFailure: viewPageFailure,
	  viewBlogSuccess: viewBlogSuccess,
	  viewBlogFailure: viewBlogFailure,
	  updateBlogSuccess: updateBlogSuccess,
	  updateBlogFailure: updateBlogFailure,
	  createPostSuccess: createPostSuccess,
	  failure: failure,
	  updatePostSuccess: updatePostSuccess,
	  updatePostFailure: updatePostFailure,
	  viewPostSuccess: viewPostSuccess,
	  viewPostFailure: viewPostFailure,
	  deletePostSuccess: deletePostSuccess,
	  deletePostFailure: deletePostFailure,
	  checkForUserBlog: checkForUserBlog,
	  checkForUserBlogSuccess: checkForUserBlogSuccess,
	  viewMyBlogSuccess: viewMyBlogSuccess,
	  viewMyBlogFailure: viewMyBlogFailure,
	  viewAllUsersSuccess: viewAllUsersSuccess,
	  viewAllUsersFailure: viewAllUsersFailure,
	  onViewUserAssets: onViewUserAssets,
	  viewUserAssetsFailure: viewUserAssetsFailure,
	  checkForUserPages: checkForUserPages
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n<div class=\"col-xs-4 box\">\n    <div data-id=\""
	    ...
	    + "\">\n      <ul name='page-name' class='handlebars-fields'>Title: <span class='handlebars' id='page-title'>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "</span></ul>\n      <button type=\"submit\" class=\"view-page\" name=\"view-page\">View Page</button>\n\n\n    <!-- "
	    + ((stack1 = __default(__webpack_require__(30)).call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1._owner : stack1),{"name":"checkUser","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + " -->\n  </div>\n</div>\n";
	  ...
	  return "<h4>User Pages</h4>\n\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.pages : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n<div class=\"col-xs-4 box\">\n    <div data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n      <ul name='blog-name' class='handlebars-fields'>Title: <span class='handlebars' id='blog-title'>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "</span></ul>\n"
	    + ((stack1 = helpers.blockHelperMissing.call(depth0,alias1((depth0 != null ? depth0.posts : depth0), depth0),{"name":"posts","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "      <input type='hidden' id=\"blog-id\" name='blog-id' value= \""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n      <button type=\"submit\" class=\"view-blog\" name=\"view-blog\">View Blog</button>\n<!--\n"
	    + ((stack1 = __default(__webpack_require__(30)).call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1._owner : stack1),{"name":"checkUser","hash":{},"fn":container.program(4, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + " -->\n  </div>\n</div>\n\n";
	},"2":function(container,depth0,helpers,partials,data) {
	    return "      <ul name='blog-posts' class='handlebars-fields'>Posts: <span class='handlebars' id='blog-posts'>"
	    + container.escapeExpression(container.lambda((depth0 != null ? depth0.title : depth0), depth0))
	    + "</span></ul>\n";
	},"4":function(container,depth0,helpers,partials,data) {
	    return "      <button type=\"submit\" class=\"remove-button\" name=\"remove-button\">Remove</button>\n      <button type=\"submit\" class=\"edit-button\" name=\"edit-button\">Edit</button>\n\n    ";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<h4>User Blog</h4>\n\n"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n<div class=\"col-xs-4 box\">\n    <div data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._owner : stack1), depth0))
	    + "\">\n      <ul name='blog-name' class='handlebars-fields'>Blog: <span class='handlebars' id='blog-title'>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "</span></ul>\n      <button type=\"submit\" class=\"edit-blog-title\" name=\"edit-blog-title\">Edit Blog Name</button>\n      <button type=\"submit\" class=\"create-blog-post\" name=\"add-blog-post\">Add a Blog Post</button>\n      <input type='hidden' id=\"blog-id\" name='blog-id' value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n      <ul name='blog-content' class='handlebars-fields'>Posts: </ul>\n"
	    + ((stack1 = helpers.each.call(alias3,(depth0 != null ? depth0.posts : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "      <button type=\"submit\" class=\"return-to-dashboard\" name=\"return-to-dashboard\">Return to dashboard</button>\n    <!-- "
	    + ((stack1 = __default(__webpack_require__(30)).call(alias3,((stack1 = blockParams[0][0]) != null ? stack1._owner : stack1),{"name":"checkUser","hash":{},"fn":container.program(4, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + " -->\n  </div>\n</div>\n";
	},"2":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

	  return "      <div class=\"post-button\">\n        <ul name='post-title' class='handlebars-fields'>Title:<span class='handlebars' id='post-title'>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "</span></ul>\n        <ul name='post-body' class='handlebars-fields'>Content:<span class='handlebars' id='post-body'>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.body : stack1), depth0))
	    + "</span></ul>\n        <input type='hidden' id=\"post-id\" name='post-id' value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n        <button type=\"submit\" class=\"remove-button\" name=\"remove-button\">Remove</button>\n        <button type=\"submit\" class=\"edit-post-button\" name=\"edit-post-button\">Edit</button>\n      </div>\n";
	},"4":function(container,depth0,helpers,partials,data) {
	    return "\n\n      <button type=\"submit\" class=\"remove-button\" name=\"remove-button\">Remove</button>\n      <button type=\"submit\" class=\"edit-button\" name=\"edit-button\">Edit</button>\n\n    ";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n<div class=\"col-xs-4 box\">\n    <div class='user-button'>\n      <ul name='user-email' type=\"submit\" class='handlebars-fields'>Email:\n        <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type='submit' class='handlebars'>\n          "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.email : stack1), depth0))
	    + "\n        </button>\n      </ul>\n    </div>\n  </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.users : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"useData":true,"useBlockParams":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n<div class=\"col-xs-4 box\">\n    <div data-id=\""
	    ...
	    + "\">\n      <ul name='page-name' class='handlebars-fields'>Title: <span class='handlebars' id='page-title'>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "</span></ul>\n      <ul name='page-content' class='handlebars-fields'>Content: <span class='handlebars' id='page-content'>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.content : stack1), depth0))
	    + "</span></ul>\n      <input type='hidden' name='page-owner' value= \""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._owner : stack1), depth0))
	    + "\">\n      <button type=\"submit\" class=\"back-to-user-site\" name=\"back-to-user-site\">Back to home</button>\n\n\n    <!-- "
	    + ((stack1 = __default(__webpack_require__(30)).call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1._owner : stack1),{"name":"checkUser","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + " -->\n  </div>\n</div>\n";
	},"2":function(container,depth0,helpers,partials,data) {
	    return "\n\n      <button type=\"submit\" class=\"remove-button\" name=\"remove-button\">Remove</button>\n      <button type=\"submit\" class=\"edit-button\" name=\"edit-button\">Edit</button>\n\n    ";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "        <ul name='post-title' class='handlebars-fields'>Title:<span class='handlebars' id='post-title'>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "</span></ul>\n        <ul name='post-body' class='handlebars-fields'>Content:<span class='handlebars' id='post-body'>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.body : stack1), depth0))
	    + "</span></ul>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n<div class=\"col-xs-4 box\">\n    <div data-id=\""
	    ...
	    + "</span></ul>\n      <ul name='page-content' class='handlebars-fields'>Content: <span class='handlebars' id='page-content'>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.content : stack1), depth0))
	    + "</span></ul>\n      <input id='page-id' type='hidden' name='page-owner' value= \""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n\n    <!-- "
	    + ((stack1 = __default(__webpack_require__(30)).call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1._owner : stack1),{"name":"checkUser","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + " -->\n  </div>\n</div>\n";
